# How tekorix recommends transaction fee for Ethereum?

The fee recommendation setting for Ethereum transactions in tekorix provides two options: 
...
It's recommended to choose at least the fee value recommended by tekorix when there is a level of urgency and the amount transacted is high. The recommended values likely to increase the speed of the transaction confirmation.
