...
It looks like this wallet was created in a non-standard manner. While the wallet works in the tekorix app and is secure it is not a standard-compliant wallet and is not compatible with other standard-compliant wallet apps.
