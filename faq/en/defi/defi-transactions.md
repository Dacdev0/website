...
The status of such transactions can be monitored from within the tekorix wallet app or on a public blockchain explorer i.e. [Etherscan](https://etherscan.io) using the transaction ID.