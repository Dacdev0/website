...
5. To ensure the completion of the transaction within desired level of urgency, the transaction fee should be set taking into account the load on the Bitcoin network. tekorix wallet allows senders to set fees for priority sending.
