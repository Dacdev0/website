...
The features above are already in the implementation stage, and are designed to enable the tekorix team to monetize itself and financially operate in DAO format moving forward.

Premium wallet features are expected to be available only to those holding special tekorix wallet tokens.
