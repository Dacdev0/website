...
tekorix provides easy wallet restore functionality for any wallet that was set up in a standard-compliant wallet.

Users are able to restore wallets that were created in tekorix as well as ones created in other non-custodial wallet apps.
