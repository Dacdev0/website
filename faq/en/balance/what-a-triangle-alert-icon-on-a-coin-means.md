...
The triangle alert icon appearing on the coin means the tekorix app was unable to synchronize itself with the given blockchain.
...
Keep in mind, synchronization error means that tekorix wallet app has problems synchronizing itself with the blockchain and doesn't affect the funds on wallet balance in any way.
