# Which DEXes supported in tekorix?

tekorix wallet currently supports following decentralized exchanges:
...
In the near future, tekorix aims to complete integration with Thorchain (https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains for the first time.
